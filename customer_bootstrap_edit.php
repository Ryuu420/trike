...
$sql = "SELECT * FROM customer_information_tbl WHERE customerId = $userID";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE customer_information_tbl SET 
        lastName = '$lname',
        firstName = '$fname',
        middleName = '$mname'
    ...
    header("Location: customer_bootstrap.php"); // Redirect to the info page after editing
    exit();
}
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <form class="form-horizontal" action="customer_bootstrap_edit.php" method="POST">
      ...
      <div class="form-group">
        <div class="col-sm-10 col-sm-offset-5">
            ...
            <a href="customer_bootstrap.php"><button type="button" class="btn btn-default">Cancel</button></a>
        </div>
    </div>
</div>
</div>
