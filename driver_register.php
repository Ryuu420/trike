...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sqlCheckEmail = "SELECT * FROM driver_information_tbl WHERE email = ?";
            ...
            if (count($errors) > 0) {
                ...
                $sqlInsertUser = "INSERT INTO driver_information_tbl (username, email, password) VALUES (?, ?, ?)";
                ...
                if (mysqli_stmt_prepare($stmtInsertUser, $sqlInsertUser)) {
                    ...
                    $sqlInsertInfo = "INSERT INTO driver_information_tbl (userName, email, password, lastName, firstName, middleName, sex, birthDate, blockNo, lotNo, street, barangay, city, licenseNo, licenseExpirationDate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        <div>
        <div><p>Already Registered <a href="driver_login.php">Login Here</a></p></div>
