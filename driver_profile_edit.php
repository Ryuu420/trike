...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE driver_information_tbl SET 
        lastName = '$lname',
        firstName = '$fname',
        middleName = '$mname'
    ...
    header("Location: driver_profile.php"); // Redirect to the info page after editing
    exit();
}
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <form class="form-horizontal" action="driver_profile_edit.php" method="POST">
