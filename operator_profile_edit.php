...
if (isset($_SESSION["user"])) {
  $userID = $_SESSION["user"]["operatorId"];
}
$sql = "SELECT * FROM operator_information_tbl WHERE operatorId = $userID";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE operator_information_tbl SET 
        lastName = '$lname',
        firstName = '$fname',
        middleName = '$mname'
    ...
    header("Location: operator_profile.php"); // Redirect to the info page after editing
    exit();
}
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <form class="form-horizontal" action="operator_profile_edit.php" method="POST">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="LName" value="<?php echo $userInfo['lastName']; ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">First Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="FName" value="<?php echo $userInfo['firstName']; ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Middle Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="MName" value="<?php echo $userInfo['middleName']; ?>">
                </div>
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-10 col-sm-offset-5">
            ...
            <a href="operator_profile.php"><button type="button" class="btn btn-default">Cancel</button></a>
        </div>
    </div>
</div>
</div>
